...
# pixels large.
html_favicon = 'images/icons/HLUIcon.png'
...
latex_documents = [
  ('index', 'HLUGISTool-UserGuide.tex', u'HLU GIS Tool - User Guide',
   u'Andy Foy', 'manual'),
]
...
man_pages = [
    ('index', 'HLUGISTool-UserGuide', u'HLU GIS Tool - User Guide',
     [u'Andy Foy'], 1)
]
...
texinfo_documents = [
  ('index', 'HLUGISTool-UserGuide', u'HLU GIS Tool - User Guide',
   u'Andy Foy', 'HLUGISTool-UserGuide', 'HLU GIS Tool - User Guide.',
   'Miscellaneous'),
]
